...
export const coreLeadership: TeamMember[] = [
  ...
  { id: "cl-12", name: "Keshav Kumar", role: "General Secretary", linkedinUrl: "#", image: "/IMG_1322 - Keshav Kumar.jpeg" },
...
export const departmentHeads: TeamMember[] = [
  ...
  { id: "dh-2", name: "Vaibhav Srivastava", role: "Co-Head", department: "SocialMedia", linkedinUrl: "#", image: "/DSC_2054 - Vaibhav Srivastava.JPG" },

  { id: "dh-2", name: "Prakhar Bajpai", role: "Head", department: "Documentation", linkedinUrl: "#", image: "/IMG_20251105_121044 (1) - PRAKHAR BAJPAI.jpg" },
  { id: "dh-2", name: "Ujjwal Goel", role: "Co-Head", department: "Documentation", linkedinUrl: "#" },
  { id: "dh-2", name: "Saloni Singh", role: "Head", department: "Club Out Reach", linkedinUrl: "#", image: "/B77C1F81-89BF-4D53-9C76-4440F2DB60A7 - Saloni Singh.jpeg" },
  { id: "dh-2", name: "Nilisha Garg", role: "Co-Head", department: "Club Out Reach", linkedinUrl: "#", image: "/IMG_20260209_200539 - Nilisha Garg.jpg" },
  { id: "dh-2", name: "Parth Mehra", role: "Head", department: "Management", linkedinUrl: "#", image: "/IMG-20260207-WA0005 - parth Mehra.jpg" },

  { id: "dh-2", name: "Utkarsh Tyagi", role: "Co-Head", department: "Management", linkedinUrl: "#", image: "/IMG_20250226_234449_530 - Utkarsh Tyagi.webp" },

];

export const teamMembers: TeamMember[] = [
  { id: "tm-1", name: "Vishal Singh ", role: "Member", department: "Event Management", image: "/IMG_8148 - vishal singh.jpeg" },
  { id: "tm-2", name: "Vansh Tyagi", role: "Member", department: "Technical Team", image: "/IMG_20251002_202703_557 - Vansh Tyagi.webp" },
  { id: "tm-3", name: "Gagan Kesarwani", role: "Member", department: "Design & Creatives", image: "/IMG_3968_Original - Gagan.jpeg" },
  { id: "tm-4", name: "Ritesh Yadav", role: "Member", department: "Public Relations", image: "/Screenshot_20260211_122256 - Ritesh Yadav.jpg" },
  ...
  { id: "tm-9", name: "Harsh Kumar", role: "Member", department: "Technical Team", image: "/IMG_20251217_012622 - Harsh Kumar.jpg" },
  ...
  { id: "tm-14", name: "Shamiksha Chaudhary", role: "Member", department: "Technical Team", image: "/IMG_1721 - Samiksha Choudhary.jpeg" },
  { id: "tm-15", name: "Priyanshu Sharma", role: "Member", department: "Technical Team", image: "/IMG_7282 - Priyanshu.jpeg" },
  ...
  { id: "tm-18", name: "Ujjwal Vashistha ", role: "Member", department: "Technical Team", image: "/IMG20241031203128~2 - Ujjwal Vashishta.jpg" },
  ...
  { id: "tm-36", name: "Aditya Chauhan", role: "Member", department: "Content & Social Media", image: "/me - ADITYA CHAUHAN.jpg" },
